...
for(i = 1; i <= 5; i++)
{
    ...
    totalSales = 0;
    //This for will allow us to move through the Quarters of each region
    for(j = 0; j < 4; j++)
    {
        ...
        {
            //if i = 2 we sum the region2 in the index j
    ...
    //We print the total Sales of the actual region
